...
I want to refine my testing pipeline. If regressions in R are not the same as in Stata, there can be different reasons. Mainly, a problem in the R translation that generates the data, or a problem in the R translation of the regression.
