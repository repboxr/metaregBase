...
I have an example where main.do calls two other do files:
...
```
mrb_r_base processing runids: 4 5 
 Error in repboxDRF::drf_get_data(pid, drf = mrb$drf, filtered = FALSE,  : 
  No R code found for getting data and no cache found. That looks like a bug.
```


Looking at the earlier parcels, we already see the problem that each line in main_part1.do and main_part2.do was entered twice...


Parcel stata_run_cmd:

# A tibble: 9 × 13
  runid root_file_path file_path          counter  line cmd   cmdline                          
  <int> <chr>          <chr>                <int> <int> <chr> <chr>                            
1     1 code/main.do   code/main.do             1     1 do    "do main_part1"                  
2     2 code/main.do   code/main_part1.do       2     1 use   "use \"../data/data.dta\", clear"
3     3 code/main.do   code/main_part1.do       2     1 use   "use \"../data/data.dta\", clear"
4     4 code/main.do   code/main_part1.do       3     2 reg   "reg y x1"                       
5     5 code/main.do   code/main_part1.do       3     2 reg   "reg y x1"                       
6     6 code/main.do   code/main.do             4     2 use   "use \"../data/data.dta\", clear"
7     7 code/main.do   code/main.do             5     3 do    "do main_part2.do"               
8     8 code/main.do   code/main_part2.do       6     1 reg   "reg y x1 i1"                    
9     9 code/main.do   code/main_part2.do       6     1 reg   "reg y x1 i1"                    
  missing_data found_path      start_time end_time errcode out_img_file
  <lgl>        <chr>           <chr>      <chr>      <dbl> <chr>       
1 FALSE        ""              18:11:11   18:11:11       0 ""          
2 FALSE        "data/data.dta" 18:11:11   18:11:11       0 ""          
3 FALSE        "data/data.dta" 18:11:11   18:11:11       0 ""          
4 FALSE        ""              18:11:11   18:11:11       0 ""          
5 FALSE        ""              18:11:11   18:11:11       0 ""          
6 FALSE        "data/data.dta" 18:11:11   18:11:11       0 ""          
7 FALSE        ""              18:11:11   18:11:11       0 ""          
8 FALSE        ""              18:11:11   18:11:11       0 ""          
9 FALSE        ""              18:11:11   18:11:11       0 ""          
...
```
Create repdb directory  ~/repbox/projects_test/test/repdb 
.
  Stata static code analysis...
...
Replicate  test  with  3  do files.

 inject code for included main_part1.do
 inject code for included main_part2.do
1 of 1 inject and run

Run  /home/rstudio/repbox/projects_test/test/mod/code/repbox_main.do
...
The screenshot shows that 3 logs were generated by repbox. Can you find the problems and ensure that our replication accounts correctly for such included files without duplicating runid and reproducing all correctly?

Describe the issue, your proposed fix, and propose the code.
