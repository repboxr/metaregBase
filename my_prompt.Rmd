...
R translation in the example below fails. I typed some debugging steps in the console below using restore.points to call parts of the function where there was a failure, the order of my calls is not always sequential, but it might provide info.

Can you find the problem, explain and propose a fix?

> # runid = 4572
> # Stata: qui eststo b1:reg credits c.mgpa#sd_above  sd_above ibn.xcats##c.appordr male young old hbo gpa , cluster(groep)
> pid = 4572
> if (!exists("parcels")) parcels = list()
...
> # generated cterm columns, and regxvar columns
> dat = metaregBase:::mrb_get_regression_data(runid = pid, drf = drf, reg = reg, regvar = regvar, regxvar = regxvar, parcels = parcels)
Error in `[[<-` at metaregBase/R/mrb_regxvar.R:169:7:
! Assigned data `v1 * v2` must be compatible with existing data.
✖ Existing data has 1876 rows.
✖ Assigned data has 0 rows.
ℹ Only vectors of size 1 are recycled.
Caused by error in `vectbl_recycle_rhs_rows()`:
! Can't recycle input of size 0 to size 1876.
Run `rlang::last_trace()` to see where the error occurred.
> regxvar
# A tibble: 45 × 6
   runid ia_cterm      cterm           role  in_regcoef org_coef
   <int> <chr>         <chr>           <chr> <lgl>         <dbl>
 1  4572 mgpa#sd_above mgpa#sd_above=1 exo   TRUE        0.101  
 2  4572 mgpa#sd_above mgpa#sd_above=0 exo   TRUE        0.0561 
 3  4572 appordr#xcats xcats=13        exo   TRUE        0.160  
 4  4572 appordr#xcats xcats=16        exo   TRUE       -0.144  
 5  4572 appordr#xcats xcats=10        exo   TRUE        0.451  
 6  4572 appordr#xcats xcats=1         exo   TRUE       -0.303  
 7  4572 appordr#xcats xcats=4         exo   TRUE       -0.317  
 8  4572 appordr#xcats xcats=7         exo   TRUE        0.185  
 9  4572 appordr#xcats xcats=11        exo   TRUE        0.00192
10  4572 appordr#xcats xcats=17        exo   TRUE        0.198  
# ℹ 35 more rows
# ℹ Use `print(n = ...)` to see more rows
> names(dat)
  [1] "id"                         "cohort"                     "groep"                     
  [4] "male"                       "age"                        "hbo"                       
  [7] "gpacat_intake"              "wisb"                       "fisc"                      
 [10] "appordr"                    "gparaw"                     "crd1raw"                   
 [13] "dropout"                    "cijfer_av_prop"             "sur"                       
 [16] "surform"                    "surv1"                      "surv2"                     
 [19] "surv3"                      "surv4"                      "surv5"                     
 [22] "surv6"                      "surv7"                      "surv8"                     
 [25] "surv9"                      "surv10"                     "surv11"                    
 [28] "surv12"                     "surv13"                     "surv14"                    
 [31] "surv15"                     "surv16"                     "surv17"                    
 [34] "surv18"                     "surv19"                     "surv20"                    
 [37] "surv21"                     "surv22"                     "surv23"                    
 [40] "surv24"                     "surv25"                     "surv26"                    
 [43] "surweb"                     "lmprop"                     "age3cat"                   
 [46] "young"                      "old"                        "sgpa"                      
 [49] "smale"                      "mmale"                      "sage"                      
 [52] "mage"                       "sappordr"                   "mappordr"                  
 [55] "sgpasq"                     "mgpaall"                    "sdgpaall"                  
 [58] "mappordrall"                "gpa3cat"                    "gpab"                      
 [61] "gpam"                       "gpat"                       "fbgpaall"                  
 [64] "fbgpa"                      "fmgpaall"                   "fmgpa"                     
 [67] "ftgpaall"                   "ftgpa"                      "gsize"                     
 [70] "surv1raw"                   "surv2raw"                   "surv3raw"                  
 [73] "surv4raw"                   "surv5raw"                   "surv6raw"                  
 [76] "surv7raw"                   "surv8raw"                   "surv9raw"                  
 [79] "surv10raw"                  "surv11raw"                  "surv12raw"                 
 [82] "surv13raw"                  "surv14raw"                  "surv15raw"                 
 [85] "surv16raw"                  "surv17raw"                  "surv18raw"                 
 [88] "surv19raw"                  "surv20raw"                  "surv21raw"                 
 [91] "surv22raw"                  "surv23raw"                  "surv24raw"                 
 [94] "surv25raw"                  "surv26raw"                  "ngr1"                      
 [97] "ngrrel1"                    "ngr2"                       "ngrrel2"                   
[100] "ngr3"                       "ngrrel3"                    "ngr4"                      
[103] "ngrrel4"                    "ngr5"                       "ngrrel5"                   
[106] "ngr6"                       "ngrrel6"                    "ngr7"                      
[109] "ngrrel7"                    "ngr8"                       "ngrrel8"                   
[112] "ngr9"                       "ngrrel9"                    "ngr10"                     
[115] "ngrrel10"                   "ngrrelav"                   "ngravall"                  
[118] "ngrav"                      "pprior"                     "amgpa"                     
[121] "asdgpa"                     "ngr0"                       "noshow"                    
[124] "pgrlate"                    "pgrfisc"                    "credits"                   
[127] "avgrade"                    "gpa"                        "wc2slow"                   
[130] "wc2fast"                    "wcstim"                     "peerconducive"             
[133] "peerinter"                  "peerobstruct"               "peerinvolve"               
[136] "xcats"                      "_est_main"                  "g1"                        
[139] "rx"                         "g2a"                        "g3a"                       
[142] "g3m"                        "g3h"                        "g3l"                       
[145] "mgpa"                       "sdgpa"                      "grid"                      
[148] "_est_iv1"                   "stata2r_original_order_idx" "xcats=13"                  
[151] "xcats=16"                   "xcats=10"                   "xcats=1"                   
[154] "xcats=4"                    "xcats=7"                    "xcats=17"                  
[157] "xcats=11"                   "xcats=14"                   "xcats=5"                   
[160] "xcats=8"                    "xcats=2"                    "xcats=18"                  
[163] "xcats=15"                   "xcats=12"                   "xcats=6"                   
[166] "xcats=9"                    "xcats=3"                    "appordr#xcats=13"          
[169] "appordr#xcats=16"           "appordr#xcats=10"           "appordr#xcats=1"           
[172] "appordr#xcats=4"            "appordr#xcats=7"            "appordr#xcats=17"          
[175] "appordr#xcats=11"           "appordr#xcats=14"           "appordr#xcats=5"           
[178] "appordr#xcats=8"            "appordr#xcats=2"            "appordr#xcats=18"          
[181] "appordr#xcats=15"           "appordr#xcats=12"           "appordr#xcats=6"           
[184] "appordr#xcats=9"            "appordr#xcats=3"            "mgpa#sdgpa"                
[187] "gpa#mgpa"                   "amgpa#asdgpa"               "gpa#sdgpa"                 
[190] "amgpa#gpa"                  "asdgpa#gpa"                 "gpa#mgpa#sdgpa"            
[193] "amgpa#asdgpa#gpa"          
> # dat is the regression-ready data, including the DRF path, filtering,
> # generated cterm columns, and regxvar columns
> dat = metaregBase:::mrb_get_regression_data(runid = pid, drf = drf, reg = reg, regvar = regvar, regxvar = regxvar, parcels = parcels)
Error in `[[<-` at metaregBase/R/mrb_regxvar.R:169:7:
...
14: (function (cnd) 
    {
        ...
        metaregBase:::mrb_get_regression_data(runid = pid, drf = drf, 
            reg = reg, regvar = regvar, regxvar = regxvar, parcels = parcels), 
        make_regxvar_cols(dat, regxvar), `[[<-`(`*tmp*`, cterms[i], 
            value = `<dbl>`), `[[<-.tbl_df`(`*tmp*`, cterms[i], value = `<dbl>`), 
        tbl_subassign(x, i, j, value, i_arg = i_arg, j_arg = NULL, 
            value_arg = value_arg), vectbl_recycle_rhs_rows(value, 
            ...
            size = 1876L, x_arg = "", call = `<env>`), stop_vctrs(x_size = x_size, 
        ...
        parent = c(0L, 1L, 2L, 2L, 4L, 5L, 6L, 6L, 0L, 9L, 10L), 
        visible = c(TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, 
        FALSE, FALSE, FALSE), namespace = c("metaregBase", "metaregBase", 
        "base", "tibble", "tibble", "tibble", "base", "vctrs", "vctrs", 
        "vctrs", "rlang"), scope = c(":::", "::", "::", ":::", ":::", 
        ":::", "::", "::", ":::", ":::", "::"), error_frame = c(FALSE, 
        FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, 
        FALSE)), row.names = c(NA, -11L), version = 2L, class = c("rlang_trace", 
    "rlib_trace", "tbl", "data.frame")), parent = NULL, x_size = 0L, 
        y_size = 1876L, x_arg = "", rlang = list(inherit = TRUE), 
...
10: stop_vctrs(x_size = x_size, y_size = size, x_arg = x_arg, class = c("vctrs_error_incompatible_size", 
        "vctrs_error_recycle_incompatible_size"), call = call)
9: stop_recycle_incompatible_size(x_size = 0L, size = 1876L, x_arg = "", 
       call = <environment>)
...
6: vectbl_recycle_rhs_rows(value, fast_nrow(xo), i_arg = NULL, value_arg, 
       call)
5: tbl_subassign(x, i, j, value, i_arg = i_arg, j_arg = NULL, value_arg = value_arg)
4: `[[<-.tbl_df`(`*tmp*`, cterms[i], value = numeric(0)) at mrb_regxvar.R#169
3: `[[<-`(`*tmp*`, cterms[i], value = numeric(0)) at mrb_regxvar.R#169
2: make_regxvar_cols(dat, regxvar) at mrb_r_reg.R#276
1: metaregBase:::mrb_get_regression_data(runid = pid, drf = drf, 
       reg = reg, regvar = regvar, regxvar = regxvar, parcels = parcels)
>   restore.point("make_regxvar_cols")

3: metaregBase:::mrb_get_regression_data(runid = pid, drf = drf, 
       reg = reg, regvar = regvar, regxvar = regxvar, parcels = parcels)
2: make_regxvar_cols(dat, regxvar)
1: restore.point("make_regxvar_cols")Restored:  dat,regxvar
>   # Don't overwrite existing columns
>   # This also should guarantee that every element of all_cterm
>   # is either a factor or an interaction term
>   all_cterms = setdiff(regxvar$cterm, names(dat))
> all_cterms
 [1] "mgpa#sd_above=1"  "mgpa#sd_above=0"  "xcats=13"         "xcats=16"         "xcats=10"        
 [6] "xcats=1"          "xcats=4"          "xcats=7"          "xcats=11"         "xcats=17"        
[11] "xcats=14"         "xcats=8"          "xcats=5"          "xcats=2"          "xcats=18"        
[16] "xcats=15"         "xcats=12"         "xcats=6"          "xcats=9"          "xcats=3"         
[21] "appordr#xcats=13" "appordr#xcats=16" "appordr#xcats=10" "appordr#xcats=1"  "appordr#xcats=4" 
[26] "appordr#xcats=7"  "appordr#xcats=11" "appordr#xcats=17" "appordr#xcats=14" "appordr#xcats=8" 
[31] "appordr#xcats=5"  "appordr#xcats=2"  "appordr#xcats=18" "appordr#xcats=15" "appordr#xcats=12"
[36] "appordr#xcats=6"  "appordr#xcats=9"  "appordr#xcats=3" 
>   num_ia = stringi::stri_count_fixed(all_cterms,"#")+1
>   # Cols without interaction effect
>   cterms = all_cterms[num_ia==1]
> cterms
 [1] "xcats=13" "xcats=16" "xcats=10" "xcats=1"  "xcats=4"  "xcats=7"  "xcats=11" "xcats=17" "xcats=14"
[10] "xcats=8"  "xcats=5"  "xcats=2"  "xcats=18" "xcats=15" "xcats=12" "xcats=6"  "xcats=9"  "xcats=3" 
>   vars = str.left.of(cterms, "=")
>   vals = str.right.of(cterms, "=")
>   for (i in seq_along(cterms)) {
+     # E.g. cols with o@ prefix can be missings
...
Run `rlang::last_trace()` to see where the error occurred.
> cterms
 [1] "mgpa#sd_above=1"  "mgpa#sd_above=0"  "appordr#xcats=13" "appordr#xcats=16" "appordr#xcats=10"
 [6] "appordr#xcats=1"  "appordr#xcats=4"  "appordr#xcats=7"  "appordr#xcats=11" "appordr#xcats=17"
[11] "appordr#xcats=14" "appordr#xcats=8"  "appordr#xcats=5"  "appordr#xcats=2"  "appordr#xcats=18"
[16] "appordr#xcats=15" "appordr#xcats=12" "appordr#xcats=6"  "appordr#xcats=9"  "appordr#xcats=3" 
>     vars1 = str.left.of(cterms, "#")
>     vars2 = str.right.of(cterms, "#")
> vars1
 [1] "mgpa"    "mgpa"    "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr"
[11] "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr"
>     vars2 = str.right.of(cterms, "#")
>     for (i in seq_along(cterms)) {
+       v1 = dat[[vars1[i]]]
+       v2 = dat[[vars2[i]]]
...
[11] "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr" "appordr"
> vars2
 [1] "sd_above=1" "sd_above=0" "xcats=13"   "xcats=16"   "xcats=10"   "xcats=1"    "xcats=4"   
 [8] "xcats=7"    "xcats=11"   "xcats=17"   "xcats=14"   "xcats=8"    "xcats=5"    "xcats=2"   
[15] "xcats=18"   "xcats=15"   "xcats=12"   "xcats=6"    "xcats=9"    "xcats=3"   
>       v1 = dat[[vars1[i]]]
> i
[1] 1
> v1
   [1] -0.5671621 -0.5670311  1.1344742 -0.5669002  1.1311127 -0.5669657 -0.5673305  1.1357408
   [9]  1.1350425  1.1347102  1.1328177  1.1347665 -0.5673305  1.1352348 -0.5671441  1.1344479
  [17] -0.5672089  1.1340357 -0.5668711  1.1354972  1.1341856 -0.5668440  1.1350425  1.1352536
  [25]  1.1305951 -0.5669002  1.1354972  1.1359234 -0.5668238 -0.5671441 -0.5673629  1.1337922
  [33] -0.5670311  1.1327691  1.1325742 -0.5663577  1.1350100 -0.5672930  1.1354972 -0.5662454
  [41] -0.5672930  1.1344479 -0.5667692  1.1313562 -0.5671076  1.1314477 -0.5668711  1.1352841
  [49]  1.1332238  1.1345228  1.1349726 -0.5665191 -0.5659017  1.1354972 -0.5669089  1.1348151
  [57] -0.5670224  1.1347102 -0.5667692  1.1342793  1.1341856  1.1314477 -0.5669657  1.1359843
  [65]  1.1352348  1.1306256 -0.5666819  1.1316323  1.1354972  1.1341331 -0.5661145 -0.5667692
  [73]  1.1325418 -0.5667692 -0.5664549  1.1347102  1.1354972 -0.5667692  1.1343604 -0.5666383
  [81]  1.1352130  1.1320870  1.1332238 -0.5665684 -0.5659254  1.1357104  1.1352348 -0.5662454
  [89] -0.5674521 -0.5666819 -0.5674764 -0.5670311 -0.5666383 -0.5668238  1.1357408 -0.5670873
  [97] -0.5668238 -0.5671621 -0.5667225 -0.5671441 -0.5672930 -0.5668440 -0.5674240 -0.5661145
