...
I have an example where for all xtivreg2 commands like 

xi: xtivreg2  cashdef (F1.bailind=gbailind L1.gbailind)taxbt pop age015 age65 unemp bailind L1.debt gdebt i.year gtaxbt gpop gage015 gage65 gunemp leftmaj voteshareleft gleftmaj gvoteshareleft ugrant gugrant if year>1978,fe cl(code)

All or a large share of coefficients of R translation and Stata original differ, often substantially. Do you see any issue in our pipeline that might be the culprit? First explain in detail the reason or multiple possible reasons, before suggesting a fix.
