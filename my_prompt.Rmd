...
I have added this field to regcheck parcel spec:
...
Can you adapt the function that creates regcheck parcel if that field is not yet (correctly) implemented?
