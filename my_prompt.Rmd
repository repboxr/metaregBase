...
The project org dir has some .ado files like here _gpeer.ado. In the original Stata reproduction these ado files seem to be used, but not in the metareg_base replication.

How to best implement? Perhaps even copying custom ado files from org to a drf/ado dir? But we may need to copy more than the ado files...

Discuss and implement your proposal.
