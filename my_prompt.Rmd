...
drf_stata_cmd_types = function() {
  ...
  list(
    ...
    mod = c("g","ge","gen","generate","replace","drop","keep","rename","ren","rena","renam","merge","egen","xtset","tsset","iis", "xtile","pctile","append","tabulate","tabul","tabu", "tab","ta","encode","predict","xi", "collapse", "sort","so","tab1", "winsor", "tostring", "destring", "recode", "expand", "reshape", "contract"),
    #scalar = c("scalar"),
...
Below is an example where the R regression coefs differ substantially from the Stata coefs. Perhaps due to the fact that Stata interaction terms with ## should be dealt differently than # interaction terms by our pipeline? Or is it another issue? Please discuss and explain before proposing a fix.


```
project_dir = "/home/rstudio/repbox/projects/ms_67_4_18"
# Stata: set matsize 11000
data = drf_load_data(project_dir, "cached_dta/32_cache.dta")
data$stata2r_original_order_idx = seq_len(nrow(data))
assign("has_original_order_idx", TRUE, envir = stata2r::stata2r_env)

# Stata: reg logdiff i.post_FDA i.older15 i.inject i.repeat_shortage i.generic_d i.therapeutic_category2 i.year#i.labelernamex2
# No R translation found/needed

# Stata: reg logdiff i.post_FDA duopoly oligo1 oligo2 i.older15 i.inject i.repeat_shortage i.generic_d i.therapeutic_category2 i.year#i.labelernamex2
# No R translation found/needed

# Stata: reg logdiff duopoly##post_FDA oligo1##post_FDA oligo2##post_FDA i.older15 i.inject i.repeat_shortage i.generic_d i.therapeutic_category2 i.year#i.labelernamex2
pid = 37
if (!exists("parcels")) parcels = list()
...
formula = `logdiff` ~ `older15=1` + `inject=1` + `repeat_shortage=1` + `generic_d=1` + `therapeutic_category2=14` + `therapeutic_category2=9` + `therapeutic_category2=6` + `therapeutic_category2=2` + `therapeutic_category2=5` + `therapeutic_category2=4` + `therapeutic_category2=7` + `therapeutic_category2=11` + `therapeutic_category2=15` + `therapeutic_category2=13` + `therapeutic_category2=3` + `therapeutic_category2=12` + `therapeutic_category2=8` + `year=2012#labelernamex2=31` + `year=2010#labelernamex2=31` + `year=2012#labelernamex2=40` + `year=2015#labelernamex2=58` + `year=2012#labelernamex2=99` + `year=2014#labelernamex2=99` + `year=2012#labelernamex2=78` + `year=2011#labelernamex2=78` + `year=2010#labelernamex2=78` + `year=2013#labelernamex2=78` + `year=2012#labelernamex2=63` + `year=2011#labelernamex2=63` + `year=2013#labelernamex2=63` + `year=2012#labelernamex2=70` + `year=2013#labelernamex2=70` + `year=2012#labelernamex2=86` + `year=2014#labelernamex2=86` + `year=2015#labelernamex2=86` + `year=2011#labelernamex2=86` + `year=2010#labelernamex2=86` + `year=2013#labelernamex2=86` + `year=2012#labelernamex2=49` + `year=2012#labelernamex2=97` + `year=2014#labelernamex2=97` + `year=2015#labelernamex2=97` + `year=2011#labelernamex2=97` + `year=2013#labelernamex2=97` + `year=2011#labelernamex2=48` + `year=2010#labelernamex2=48` + `year=2012#labelernamex2=33` + `year=2011#labelernamex2=33` + `year=2012#labelernamex2=2` + `year=2014#labelernamex2=2` + `year=2013#labelernamex2=2` + `year=2014#labelernamex2=17` + `year=2013#labelernamex2=17` + `year=2012#labelernamex2=20` + `year=2014#labelernamex2=20` + `year=2015#labelernamex2=20` + `year=2011#labelernamex2=20` + `year=2010#labelernamex2=20` + `year=2013#labelernamex2=20` + `year=2012#labelernamex2=61` + `year=2014#labelernamex2=61` + `year=2015#labelernamex2=61` + `year=2012#labelernamex2=57` + `year=2011#labelernamex2=57` + `year=2013#labelernamex2=57` + `year=2012#labelernamex2=46` + `year=2014#labelernamex2=46` + `year=2015#labelernamex2=46` + `year=2011#labelernamex2=46` + `year=2010#labelernamex2=46` + `year=2013#labelernamex2=46` + `year=2014#labelernamex2=36` + `year=2011#labelernamex2=6` + `year=2014#labelernamex2=18` + `year=2012#labelernamex2=96` + `year=2014#labelernamex2=96` + `year=2011#labelernamex2=96` + `year=2013#labelernamex2=96` + `year=2011#labelernamex2=74` + `year=2012#labelernamex2=80` + `year=2014#labelernamex2=80` + `year=2015#labelernamex2=80` + `year=2011#labelernamex2=80` + `year=2013#labelernamex2=80` + `year=2011#labelernamex2=55` + `year=2014#labelernamex2=67` + `year=2010#labelernamex2=75` + `year=2013#labelernamex2=15` + `year=2014#labelernamex2=88` + `year=2013#labelernamex2=1` + `year=2012#labelernamex2=4` + `year=2014#labelernamex2=4` + `year=2013#labelernamex2=4` + `year=2015#labelernamex2=44` + `year=2013#labelernamex2=44` + `year=2015#labelernamex2=19` + `year=2015#labelernamex2=28` + `year=2012#labelernamex2=79` + `year=2014#labelernamex2=79` + `year=2015#labelernamex2=79` + `year=2011#labelernamex2=79` + `year=2010#labelernamex2=79` + `year=2013#labelernamex2=79` + `year=2014#labelernamex2=27` + `year=2010#labelernamex2=27` + `year=2013#labelernamex2=27` + `year=2014#labelernamex2=100` + `year=2014#labelernamex2=84` + `year=2015#labelernamex2=84` + `year=2011#labelernamex2=84` + `year=2012#labelernamex2=68` + `year=2013#labelernamex2=68` + `year=2014#labelernamex2=69` + `year=2014#labelernamex2=94` + `year=2012#labelernamex2=85` + `year=2014#labelernamex2=34` + `year=2012#labelernamex2=89` + `year=2011#labelernamex2=8` + `year=2012#labelernamex2=81` + `year=2013#labelernamex2=81` + `year=2014#labelernamex2=30` + `year=2011#labelernamex2=30` + `year=2014#labelernamex2=13` + `year=2013#labelernamex2=13` + `year=2011#labelernamex2=10` + `year=2013#labelernamex2=10` + `year=2010#labelernamex2=24` + `year=2012#labelernamex2=47` + `year=2014#labelernamex2=47` + `year=2011#labelernamex2=47` + `year=2010#labelernamex2=47` + `year=2013#labelernamex2=53` + `year=2012#labelernamex2=38` + `year=2014#labelernamex2=38` + `year=2015#labelernamex2=38` + `year=2011#labelernamex2=38` + `year=2010#labelernamex2=38` + `year=2013#labelernamex2=38` + `year=2012#labelernamex2=98` + `year=2015#labelernamex2=7` + `year=2011#labelernamex2=7` + `year=2014#labelernamex2=87` + `year=2014#labelernamex2=14` + `year=2015#labelernamex2=14` + `year=2013#labelernamex2=14` + `year=2012#labelernamex2=25` + `year=2012#labelernamex2=29` + `year=2013#labelernamex2=29` + `year=2014#labelernamex2=62` + `year=2015#labelernamex2=62` + `year=2013#labelernamex2=62` + `year=2012#labelernamex2=77` + `year=2014#labelernamex2=43` + `year=2014#labelernamex2=3` + `year=2013#labelernamex2=3` + `year=2014#labelernamex2=101` + `year=2015#labelernamex2=101` + `year=2012#labelernamex2=42` + `year=2014#labelernamex2=42` + `year=2015#labelernamex2=42` + `year=2011#labelernamex2=42` + `year=2014#labelernamex2=64`
ssc = fixest::ssc()
reg_vcov = "iid"
...
# Some parcels for runid=37

All parcel contents for runid=37

Parcel regcoef:

# A tibble: 446 × 12
   runid variant cterm                shown_term             label eq      coef     se      t
   <int> <chr>   <chr>                <chr>                  <chr> <chr>  <dbl>  <dbl>  <dbl>
 1    37 sb      duopoly=0            0b.duopoly             ""    ""    NA     NA     NA    
 2    37 sb      duopoly=1            1.duopoly              ""    ""     0.863  0.338  2.55 
 3    37 sb      post_FDA=0           0b.post_FDA            ""    ""    NA     NA     NA    
 4    37 sb      post_FDA=1           1.post_FDA             ""    ""     0.534  0.402  1.33 
 5    37 sb      duopoly=0#post_FDA=0 0b.duopoly#0b.post_FDA ""    ""    NA     NA     NA    
 6    37 sb      duopoly=0#post_FDA=1 0b.duopoly#1o.post_FDA ""    ""    NA     NA     NA    
 7    37 sb      duopoly=1#post_FDA=0 1o.duopoly#0b.post_FDA ""    ""    NA     NA     NA    
 8    37 sb      duopoly=1#post_FDA=1 1.duopoly#1.post_FDA   ""    ""    -1.32   0.490 -2.70 
 9    37 sb      oligo1=0             0b.oligo1              ""    ""    NA     NA     NA    
10    37 sb      oligo1=1             1.oligo1               ""    ""     0.235  0.339  0.691
          p ci_low  ci_up
      <dbl>  <dbl>  <dbl>
 1 NA        0      0    
 2  0.0113   0.197  1.53 
 ...
 6 NA        0      0    
 7 NA        0      0    
 8  0.00746 -2.29  -0.357
 9 NA        0      0    
10  0.490   -0.434  0.903
# ℹ 436 more rows
...
# A tibble: 446 × 12
   runid variant cterm                shown_term             label      eq      coef     se     t
   <int> <chr>   <chr>                <chr>                  <chr>      <chr>  <dbl>  <dbl> <dbl>
 1    37 so      (Intercept)          _cons                  "Constant" ""     5.27   1.10   4.79
 2    37 so      duopoly=0            0b.duopoly             ""         ""    NA     NA     NA   
 3    37 so      duopoly=0#post_FDA=0 0b.duopoly#0b.post_FDA ""         ""    NA     NA     NA   
 4    37 so      duopoly=0#post_FDA=1 0b.duopoly#1o.post_FDA ""         ""    NA     NA     NA   
 5    37 so      duopoly=1            1.duopoly              ""         ""     0.863  0.338  2.55
 6    37 so      duopoly=1#post_FDA=0 1o.duopoly#0b.post_FDA ""         ""    NA     NA     NA   
 7    37 so      duopoly=1#post_FDA=1 1.duopoly#1.post_FDA   ""         ""    -1.32   0.490 -2.70
 8    37 so      generic_d=0          0b.generic_d           ""         ""    NA     NA     NA   
 9    37 so      generic_d=1          1.generic_d            ""         ""    -0.218  0.201 -1.09
10    37 so      inject=0             0b.inject              ""         ""    NA     NA     NA   
             p ci_low  ci_up
         <dbl>  <dbl>  <dbl>
 1  0.00000280  3.11   7.44 
 2 NA           0      0    
 3 NA           0      0    
 4 NA           0      0    
 5  0.0113      0.197  1.53 
 6 NA           0      0    
 7  0.00746    -2.29  -0.357
 8 NA           0      0    
 9  0.277      -0.614  0.177
10 NA           0      0    
# ℹ 436 more rows
...
# A tibble: 163 × 12
   runid variant cterm                    shown_term                 label eq       coef    se
   <int> <chr>   <chr>                    <chr>                      <chr> <chr>   <dbl> <dbl>
 1    37 rb      (Intercept)              (Intercept)                ""    ""     5.98   1.09 
 2    37 rb      older15=1                `older15=1`                ""    ""    -0.0811 0.862
 3    37 rb      inject=1                 `inject=1`                 ""    ""     0.568  0.240
 4    37 rb      repeat_shortage=1        `repeat_shortage=1`        ""    ""     0.289  0.143
 5    37 rb      generic_d=1              `generic_d=1`              ""    ""    -0.392  0.190
 6    37 rb      therapeutic_category2=14 `therapeutic_category2=14` ""    ""     0.0406 0.636
 7    37 rb      therapeutic_category2=9  `therapeutic_category2=9`  ""    ""    -0.129  0.664
 8    37 rb      therapeutic_category2=6  `therapeutic_category2=6`  ""    ""     0.232  0.650
 9    37 rb      therapeutic_category2=2  `therapeutic_category2=2`  ""    ""    -0.0365 0.649
10    37 rb      therapeutic_category2=5  `therapeutic_category2=5`  ""    ""     0.595  0.634
         t           p   ci_low   ci_up
     <dbl>       <dbl>    <dbl>   <dbl>
 1  5.48   0.000000100  3.83     8.13  
 2 -0.0941 0.925       -1.78     1.62  
 3  2.37   0.0186       0.0956   1.04  
 4  2.02   0.0443       0.00746  0.570 
 5 -2.07   0.0399      -0.765   -0.0182
 6  0.0638 0.949       -1.21     1.29  
 7 -0.194  0.846       -1.44     1.18  
 8  0.356  0.722       -1.05     1.51  
 9 -0.0561 0.955       -1.32     1.24  
10  0.938  0.349       -0.653    1.84  
# ℹ 153 more rows
# ℹ Use `print(n = ...)` to see more rows
...
# A tibble: 14 × 17
   runid variant cterm                 ia_cterm              basevar               role  var_org_type
   <int> <chr>   <chr>                 <chr>                 <chr>                 <chr> <chr>       
 1    37 sb      older15               older15               older15               exo   integer     
 2    37 sb      inject                inject                inject                exo   dummy       
 3    37 sb      repeat_shortage       repeat_shortage       repeat_shortage       exo   dummy       
 4    37 sb      generic_d             generic_d             generic_d             exo   dummy       
 5    37 sb      therapeutic_category2 therapeutic_category2 therapeutic_category2 exo   integer     
 6    37 sb      year                  year#labelernamex2    year                  exo   integer     
 7    37 sb      labelernamex2         year#labelernamex2    labelernamex2         exo   integer     
 8    37 sb      duopoly               duopoly#post_FDA      duopoly               exo   dummy       
 9    37 sb      post_FDA              duopoly#post_FDA      post_FDA              exo   dummy       
10    37 sb      oligo1                oligo1#post_FDA       oligo1                exo   dummy       
11    37 sb      post_FDA              oligo1#post_FDA       post_FDA              exo   dummy       
12    37 sb      oligo2                oligo2#post_FDA       oligo2                exo   dummy       
13    37 sb      post_FDA              oligo2#post_FDA       post_FDA              exo   dummy       
14    37 sb      logdiff               logdiff               logdiff               dep   numeric     
   var_reg_type ia_reg_type absorbed_fe main_pos ia_pos ia_num ia_source_expr         
   <chr>        <chr>       <lgl>          <int>  <int>  <int> <chr>                  
 1 factor       factor      FALSE              5      1      1 i.older15              
 2 factor       factor      FALSE              6      1      1 i.inject               
 3 factor       factor      FALSE              7      1      1 i.repeat_shortage      
 4 factor       factor      FALSE              8      1      1 i.generic_d            
 5 factor       factor      FALSE              9      1      1 i.therapeutic_category2
 6 factor       factor      FALSE             10      1      2 i.year#i.labelernamex2 
 7 factor       factor      FALSE             10      2      2 i.year#i.labelernamex2 
 8 dummy        dummies     FALSE              2      1      2 duopoly##post_FDA      
 9 dummy        dummies     FALSE              2      2      2 duopoly##post_FDA      
10 dummy        dummies     FALSE              3      1      2 oligo1##post_FDA       
11 dummy        dummies     FALSE              3      2      2 oligo1##post_FDA       
12 dummy        dummies     FALSE              4      1      2 oligo2##post_FDA       
13 dummy        dummies     FALSE              4      2      2 oligo2##post_FDA       
14 numeric      numeric     FALSE              1      1      1 logdiff                
   var_source_expr         transform transform_par
   <chr>                   <chr>     <chr>        
 1 i.older15               "i"       "1"          
 2 i.inject                "i"       "1"          
 3 i.repeat_shortage       "i"       "1"          
 4 i.generic_d             "i"       "1"          
 5 i.therapeutic_category2 "i"       "1"          
 6 i.year                  "i"       "1"          
 7 i.labelernamex2         "i"       "1"          
 8 duopoly                 ""        ""           
 9 post_FDA                ""        ""           
10 oligo1                  ""        ""           
11 post_FDA                ""        ""           
...
# A tibble: 746 × 6
 ...
 1    37 older15               older15=0                exo   FALSE        NA    
 2    37 older15               older15=NA               exo   FALSE        NA    
 3    37 older15               older15=1                exo   TRUE         -0.293
 4    37 inject                inject=1                 exo   TRUE          0.517
 5    37 inject                inject=0                 exo   FALSE        NA    
 6    37 repeat_shortage       repeat_shortage=0        exo   FALSE        NA    
 7    37 repeat_shortage       repeat_shortage=1        exo   TRUE          0.302
 8    37 generic_d             generic_d=0              exo   FALSE        NA    
 9    37 generic_d             generic_d=1              exo   TRUE         -0.218
10    37 therapeutic_category2 therapeutic_category2=14 exo   TRUE         -0.234
# ℹ 736 more rows
# ℹ Use `print(n = ...)` to see more rows
...
# A tibble: 1 × 19
  runid reg_ok so_raw_did_run sb_raw_did_run so_did_run sb_did_run rb_did_run sb_so_identical
  <int> <lgl>  <lgl>          <lgl>          <lgl>      <lgl>      <lgl>      <lgl>          
1    37 FALSE  TRUE           TRUE           TRUE       TRUE       TRUE       TRUE           
  sb_so_coef_max_dev rb_sb_coef_same rb_sb_coef_max_dev rb_sb_se_same rb_sb_se_max_dev
               <dbl> <lgl>                        <dbl> <lgl>                    <dbl>
1                  0 FALSE                         2.63 FALSE                   0.0813
  rb_sb_share_coeff_same sb_num_coef repair_code cached_runid
                   <dbl>       <int> <chr>              <int>
1                      0         446 c                     32
  problem                                              comment
  <chr>                                                <chr>  
1 R and Stata base coefficients differ by > tolerance. ""     
