...
Currently newey regressions are not translated to R. E.g.

newey lnflupneu post37 year_c post37Xyear_c, lag(2)

Can you discuss how complex it would be to implement an R translation and then propose code changes?
