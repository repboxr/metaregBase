...
I get an error in an example in the intermediate data file generation in an example that has a line in the do file:

erase "Z:/DatiConsip/Data/PA_FE_all.dta";
...
✖ Empty name found at location 5.


Looking inside the function at the data frame, we see




> df
              file_path donum line counter  NA
1       St793850.000001     1   17      17  NA
2       St793850.000002     1   36      36  NA
3       St793850.000003     1  167     165  NA
4       St793850.000002     1   52      50  NA
5  code/master_data.dta     3    2       2  NA
6   code/using_data.dta     3    5       5  NA
7  code/master_data.dta     4    2       2  NA
8   code/using_data.dta     4    5       5  NA
9    data/PA_FE_all.dta    NA    2     336 336
10      data/PA_FE0.dta    NA    2     334 334
11      data/PA_FE1.dta    NA    2     335 335
12    data/refprice.dta    NA    2     337 337
13    data/refprice.dta     2  281     281  NA
14        data/temp.dta    40    4       4  NA
15        data/temp.dta    40    8       8  NA

And the injected do code is:

* PRECOMAND INJECTION START LINE 336

global repbox_cmd_count = $repbox_cmd_count +1
local repbox_local_cmd_count = $repbox_cmd_count
local repbox_cmdline = `"erase "Z:/DatiConsip/Data/PA_FE_all.dta";"'


local repbox_source_path = subinstr("Z:/DatiConsip/Data/PA_FE_all.dta;","\","/",.)

repbox_correct_path "file_exists" "`repbox_source_path'" "" "/home/rstudio/repbox/projects_test/test/mod" "/home/rstudio/repbox/projects_test/test/mod/code"
capture noisily local repbox_corrected_path = "`r(repbox_corrected_path)'"


Looking at 

subinstr("Z:/DatiConsip/Data/PA_FE_all.dta;","\","/",.)

We see that the ; at the end of the command is added to the filename in our injection code which yields the subsequent errors. 

Can you detect the bug in the code given, or is there relevant code missing?

Explain and if possible provide a fix and explain it.
